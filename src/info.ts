...
const services: Service[] = [
  {
    ...
    description: ["테란은 농업 데이터 분석을 통한 농산물 가격예측 서비스입니다.", "모든 국민은 법 앞에 평등하다. 누구든지 성별·종교 또는 사회적 신분에 의하여 정치적·경제적·사회적·문화적 생활의 모든 영역에 있어서 차별을 받지 아니한다.","테란은 농업 데이터 분석을 통한 농산물 가격예측 서비스입니다.",]
  },
  {
    title: "TERRAN",
    imageSource: "/static/asset/terranlogo.svg",
