...
const services: Service[] = [
  {
    title: "TERRAN",
    imageSource: "/static/asset/terranlogo.svg",
    description: ["테란은 농업 데이터 분석을 통한 농산물 가격예측 서비스입니다.", "모든 국민은 법 앞에 평등하다. 누구든지 성별·종교 또는 사회적 신분에 의하여 정치적·경제적·사회적·문화적 생활의 모든 영역에 있어서 차별을 받지 아니한다.","테란은 농업 데이터 분석을 통한 농산물 가격예측 서비스입니다.","눈이 광야에서 피가 들어 든 지혜는 그것을 꽃 칼이다. 아니한 우리의 사는가 피는 영원히 청춘의 이성은 그러므로 아름다우냐? 커다란 동력은 있을 인간이 것이다. 피어나는 창공에 이상의 그들의 천고에 쓸쓸한 바이며, 아니다. 같으며, 인생의 보이는 위하여서. 별과 반짝이는 부패를 사람은 우리 석가는 인생에 못할 교향악이다. 이상의 이것은 만물은 가지에 역사를 산야에 이성은 원대하고, 끓는 때문이다. 청춘의 피어나는 동력은 이것은 없으면, 열락의 위하여, 광야에서 피다. 안고, 있는 공자는 미묘한 넣는 끓는다. 이상은 따뜻한 소담스러운 이것이다. 것은 사라지지 내는 역사를 뜨거운지라, 방지하는 뿐이다.",]
  },
  {
    title: "TERRAN",
    imageSource: "/static/asset/terranlogo.svg",
